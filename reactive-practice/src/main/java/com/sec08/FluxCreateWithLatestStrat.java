...
public class FluxCreateWithLatestStrat {
     private static final Logger logger = LoggerFactory.getLogger(FluxCreateWithLatestStrat.class);
    ...
    public static void main(String[] args) {
        ...
        producer
            ...
            .map(FluxCreateWithLatestStrat::timeConsumingTask)
