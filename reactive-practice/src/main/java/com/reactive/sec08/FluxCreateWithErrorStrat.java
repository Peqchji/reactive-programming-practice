...
public class FluxCreateWithErrorStrat {
     private static final Logger logger = LoggerFactory.getLogger(FluxCreateWithErrorStrat.class);
    ...
    public static void main(String[] args) {
        ...
        producer
            ...
            .map(FluxCreateWithErrorStrat::timeConsumingTask)
